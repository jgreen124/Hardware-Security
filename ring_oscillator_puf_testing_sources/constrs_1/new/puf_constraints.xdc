...
##Buttons
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS33} [get_ports en]
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports led_toggle]
set_property -dict {PACKAGE_PIN K19 IOSTANDARD LVCMOS33} [get_ports en_mux1]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports en_mux2]
...
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[0].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[1].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[2].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[3].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[4].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[5].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[6].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[7].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[8].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[9].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[10].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[11].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[12].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[13].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[14].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[15].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[16].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[17].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[18].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[19].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[20].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[21].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[22].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[23].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[24].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[25].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[26].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[27].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[28].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[29].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[30].ro_inst/w1}]
set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets {ro_mux_inst/ro_array_inst/gen_ro_array[31].ro_inst/w1}]
