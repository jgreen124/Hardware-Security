...
#
# Script generated by Vivado on Tue Apr 08 14:40:03 EDT 2025
...
export RDI_DATADIR="/home/joshg/.local/share/xilinx/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "bram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bram xil_defaultlib.bram xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/joshg/.local/share/xilinx/Vivado/2024.2/data/xsim"
  fi
